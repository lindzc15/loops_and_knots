...
class FavoritesService:
    ...
    def get_favorite_yarns(self, request) -> YarnIDResponse:
        return self.favorites_repository.get_favorite_yarns(request)

    def add_favorite_yarn(self, request) -> RegisterResponse:
        return self.favorites_repository.add_favorite_yarn(request)
    
    def delete_favorite_yarn(self, request) -> RegisterResponse:
        return self.favorites_repository.delete_favorite_yarn(request)

    def get_favorite_patterns(self, request) -> PatternIDResponse:
        return self.favorites_repository.get_favorite_patterns(request)

    def add_favorite_pattern(self, request) -> RegisterResponse:
        return self.favorites_repository.add_favorite_pattern(request)
    
    def delete_favorite_pattern(self, request) -> RegisterResponse:
